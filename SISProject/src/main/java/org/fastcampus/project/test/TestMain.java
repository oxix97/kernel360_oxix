...
public class TestMain {
    ...
    public void creatSubject() {
        ...
        korean = new SubjectJ("국어", Define.KOREAN.code);
        math = new SubjectJ("수학", Define.MATH.code);
        dance = new SubjectJ("방송댄스", Define.DANCE.code);

        dance.setGradeType(Define.PF_TYPE.code);
